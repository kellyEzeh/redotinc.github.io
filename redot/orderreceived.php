			...
			<div class="row">
				<div class="col text-center">
					...
					if(isset($_POST['email'])) {
					    ...
					    $email_subject = "Chamuze Order Form";
					  ...
					  if(strlen($error_message) > 0) {
					    ...
					    $email_message .= "Product Code: ".clean_string($product)."\n";
					    $email_message .= "Comments: ".clean_string($message)."\n";
					    
					    $email_messageRep = "Thank you for placing your oder with us. A member of our team will be in touch with you to conclude the sale process.\n\n";
					    
					    $email_messageRep .= "Chamuze Limited";
					...
					// This is the customer email for the order.
					$headersRep = 'From: '."info@chamuze.com"."\r\n".
					'Reply-To: '.$email_to."\r\n" .
					'X-Mailer: PHP/' . phpversion();
					@mail($email, $email_subject, $email_messageRep, $headersRep);
